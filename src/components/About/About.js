...
const About = () => {
  ...
  const skillsIcons = [
    ...
    <SiTailwindcss color="#2196f3" size="50" />,
    ...
    <SiGraphql color="#e535ab" size="50" />,
  ];
  ...
  return (
    ...
    >
      <div className="portfolio__about-content">
        ...
        <div>
          <p>
            Passionate front-end web developer using JavaScript, TypeScript and
            CSS to build all aspects of the user experience and user interface
            for client-facing landing pages. Specializes in using React and
            NextJs to build e-commerce sites.
          </p>
